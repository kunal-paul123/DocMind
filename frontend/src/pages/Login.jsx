    ...
    <div className="auth-page">
      ...
      <div className="auth-card fade-in">
        <div className="auth-card-header">
          ...
          <p className="auth-subtitle">Sign in to access your research assistant</p>
        </div>
        ...
        >
          {loading ? (
            <span className="spin" style={{ display: 'inline-block', width: 18, height: 18, border: '2px solid #ccc', borderTopColor: '#333', borderRadius: '50%' }} />
          ) : (
            <GoogleIcon />
          )}
